...
import org.uma.jmetal.algorithm.multiobjective.moead.aspMOEADFS;
 ...
 */
public class aspMOEADFSRunner extends AbstractAlgorithmRunner {
    /**
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        algorithm = (aspMOEADFS) new MOEADBuilder(problem, MOEADBuilder.Variant.aspMOEADFS)
        ...
        List<aspMOEADFS.SubProcess> subAlgorithmList = algorithm.getAlgorithmList();
        ...
        for (int subPopulationIndex = 0; subPopulationIndex < subPopulationNum; subPopulationIndex++){
            aspMOEADFS.SubProcess subAlgorithm = subAlgorithmList.get(subPopulationIndex);
