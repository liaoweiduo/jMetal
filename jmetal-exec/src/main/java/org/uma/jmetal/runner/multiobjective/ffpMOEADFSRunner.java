 ...
 */
public class ffpMOEADFSRunner extends AbstractAlgorithmRunner {
    /**
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        algorithm = (ffpMOEADFS) new MOEADBuilder(problem, MOEADBuilder.Variant.ffpMOEADFS)
